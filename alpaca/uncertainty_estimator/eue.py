...
class EnsembleMCDUE:
    ...
    def __init__(self, net, nn_runs=5, dropout_rate=0.5):
        self.net = net
    ...
    def estimate(self, X_pool, **kwargs):
        ...
        with torch.no_grad():
            for nn_run in range(self.nn_runs):
                prediction = self.net(
                    X_pool, reduction=None, dropout_rate=self.dropout_rate, **kwargs
                )
...
class EnsembleMCDUEMasked:
    ...
    def __init__(self, net, nn_runs=25, dropout_rate=0.5, dropout_mask=None):
        self.net = net
        self.nn_runs = nn_runs
        self.dropout_rate = dropout_rate
